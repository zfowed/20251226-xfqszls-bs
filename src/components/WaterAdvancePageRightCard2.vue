  ...
  <PageCard title="渠系工程安全预警" bg-class="right">
    <div class="page-container">
      ...
      <ElTable :data="displayList" class="files-table water-warn-table" :max-height="410">
        ...
        <ElTableColumn prop="stnm" label="站点" />
        <ElTableColumn prop="warnText" label="渠道" />
        <ElTableColumn prop="waterValue" label="水位" />
        <ElTableColumn prop="waterValue" label="流量" />
        <ElTableColumn prop="publishTime" label="预警信息" />
      </ElTable>
    </div>
  </PageCard>
</template>
...
const displayList = ref<WarnRow[]>([
  { stnm: 'XXX站点', warnText: '高温预警', waterValue: 1, publishTime: '高温预警' },
  { stnm: 'XXX站点', warnText: '高温预警', waterValue: 2, publishTime: '高温预警' },
  { stnm: 'XXX站点', warnText: '高温预警', waterValue: 1, publishTime: '高温预警' },
  { stnm: 'XXX站点', warnText: '高温预警', waterValue: 2, publishTime: '高温预警' }
])
const totalWarnCount = ref(5)
